                  ...
                  <?php if ($flagEnvio=="ok") : ?>
                   ...
                   <?php endif; ?>
                    ...
                    <div class="account-form form-style">
                        ...
                        <form action="contactoSend2.php" method="post">
                        <input type="hidden" name="tipo" value="CONTACTO">
                            <div class="row">
                                <div class="col-12 col-sm-6">
                                    <input type="text" placeholder="Nombre" id="fname" name="nombre" maxlength="40" required>
                                </div>
                                <div class="col-12  col-sm-6">
                                    <input type="text" placeholder="Email" id="email" name="email" maxlength="40" required>
                                </div>
                                <div class="col-12">
                                    <input type="text" placeholder="Teléfono" id="subject" name="telefono" maxlength="40">
                                </div>
                                <div class="col-12">
                                    <textarea class="contact-textarea" placeholder="Mensaje" maxlength="550" rows="4" name="mensaje"></textarea>
                                </div>
                                <div class="col-12">
                                    <div class="g-recaptcha" data-sitekey="6Lc5IhUUAAAAANoax8NG5hCBwLNmz6zOkUnSNSPr"></div>
                                </div>
                                <div class="col-12">
                                    <button id="submit" name="submit">Contactar</button>
                    ...
                    <div class="contact-wrap">
                        <ul>
                            ...
                            <li>
                                ...
                                <p>
                                    <span><a href="https://wa.me/5491149864409">+1 (786) 351-8210</a></span>
