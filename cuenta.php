                    ...
                    <aside class="sidebar-area">
                        <div class="widget widget_categories">
                            <ul>
                                ...
                                <li><a href="#"><strong>My Orders</strong></a></li>
                                <li><a href="wishlist"><strong>Wishlist</strong></a></li>
                                <li><a href="perfil"><strong>My Profile</strong></a></li>
                                ...
                                <tr>
                                        ...
                                        <tbody>
                                            ...
                                            <?php while ($stmt->fetch()) {
                                              ...
                                              $id_pedido2=encriptar($id_pedido, $enc33);

                                              $estado=obtenerEstadoIngles($estado);
                                          ...
                                          <tr class="first odd">
                                            ...
                                            <td><h3"> <?php echo cambiaf_a_normal($fecha);?> | <?php echo $hora;?> </h2></td>

                                            <td><h3"> <?php echo $id_pedido;?> </h2></td>


                                                <td><h3"> <?php echo $estado;?> </h2></td>


                                            <td >

                                                <a href="pedido.php?sde=<?php echo $id_pedido2; ?>" class="linkMedida">See Purchase</a>
                                      ...
                                      <?php If ($flagPedido == 0){?>
                                        <br>
                                        <h4>You don't have registered orders.</h4>
                                       <?php } ?>
                                    </fieldset>
