        ...
        <div class="row">
          ...
          <div class="col d-none d-sm-block">
            <div class="col-lg-7 col-sm-7 col-7">
              <?php include ("inc-form-checkout.php");?>
            </div>
            ...
            <div class="col-lg-4 col-sm-4 col-4">
              <div class="order-area">
                ...
                <ul class="total-cost">
                  ...
                  <li>Total Pesos<span class="pull-right">$ <?php echo money_format('%(#10n', $totalcoste);?></span></li>
                </ul>
              </div>
            </div>
          </div>
          ...
          <div class="d-lg-none d-xl-none">
            ...
            <div class="col-lg-4 col-sm-4 col-12">
              <?php carritoTemporal("checkout-xs"); ?>
              <?php $totalcoste=carritoTemporalTotal();
              $totalcosteDolares=$totalcoste;
              $precioDolar=consultaDolar();
              $totalcoste=$totalcoste*$precioDolar;
              ...
              <div class='container'>
                ...
                <div class='row'>
                  <div class='col text-right'>
                    <span class="txt-total-xs"><b>Total <b>U&#36D <?php echo money_format('%(#10n', $totalcosteDolares);?></b></span><br>
                    <span class="txt-total-xs"><b>Total Pesos $ <?php echo money_format('%(#10n', $totalcoste);?></b></span>
                  </div>
                </div>
                <div class='row'><hr></div>
              </div>
