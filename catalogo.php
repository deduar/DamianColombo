...
<title><?php echo utf8_encode($datosCategoria[1])." - ".utf8_encode($datosCategoria[0]); ?></title>
...
<div class="breadcumb-area ptb-15">
      <div class="container">
        <div class="row">
          <div class="col-12">
            <div class="bg-lg-img-<?php echo $codSubCategoria;?>">
              <h4><?php obtenerTitulo($codCategoria, $codSubCategoria);?></h4>
            </div>
