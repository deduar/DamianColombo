...
$result = mysql_query("UPDATE pedidos SET descuentoTotal=$descuentoTotal WHERE id_pedido=$id_pedido", $link);
	...
	for ($a = 1; $a <= $cont; $a+=1) {
		...
		$var4=$_POST[$aux4];
			...
			If ($var4 != "") {
				$result = mysql_query("UPDATE det_pedidos SET descuento=$var4 WHERE id_detpedido=$var", $link);
				echo "UPDATE det_pedidos SET descuento=$var4 WHERE id_detpedido=$var<br>	";
			}
