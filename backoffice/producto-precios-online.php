...
if (move_uploaded_file($_FILES['archivo']['tmp_name'], $uploadfile)) {
     ...
     $result = mysql_query("DELETE FROM onlinePrecio", $link);
      ...
      //  echo "SUBIO ARCHIVO 2 >>>> <br>";
        ...
        if (($gestor = fopen($nombreArchivo, "r")) !== FALSE) {
            while (($datos = fgetcsv($gestor, 1000, ";")) !== FALSE) {
                ...
                //for ($c=0; $c < $numero; $c++) {
                   // echo $datos[$c] . "<br />\n";
                    ...
                    If ($fecha){
                        $fecha=cambiafechamysqlini($fecha);
                    }else{
                        $fecha="0000-00-00";
                    }
           ...
           //     echo "INSERT INTO negociosPrecioBorrar (codigo, precio, stock, fecha) VALUES ('$var1', '$var2', '$var3', '$fecha')";
            ...
            $result = mysql_query("INSERT INTO onlinePrecio (codigo, precio, stock, fecha) VALUES ('$var1', '$var2', '$var3', '$fecha')", $link);
                ...
                <div class="">
                    <div class="page-title">
                        <div class="title_left">
                            <h3>Productos | Actualización Precios Vivre ON LINE</h3>
                        </div>
...
<ul>
    ...
    <li>Formato Fecha DD/MM/AAAA</li>
</ul>
</ul>
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <img src="images/ayudaCsv.jpg">
                ...
                <form action="producto-precios-online.php" method="post" enctype="multipart/form-data" name="form1"  class="form-horizontal form-label-left">
