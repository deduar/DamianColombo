           ...
           <!-- Top Nav -->
            ...
            <div class="right_col" role="main">
                <div class="">
                    ...
                    <div class="row">
                                    <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="post" action="pedidos-agregar.php?id_pedido=<? echo $id_pedido; ?>">
                                ...
                                <? while ($row = mysql_fetch_array($result)) { ?>
                                    <tr class="even pointer">
                                        ...
                                        <td class=" last">
                                            ...
                                            <a href="pedidos-agregar2.php?codigo=<? echo $row["codigo"]; ?>&idProductMain=<? echo $row["idProductMain"]; ?>&id_pedido=<? echo $id_pedido; ?>">Agregar</a>
