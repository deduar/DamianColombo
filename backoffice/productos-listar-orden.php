...
<!--/////////////////////////////////////////////////////////////////////// -->                                   
                       ...
                       <table class='table table-striped responsive-utilities jambo_table bulk_action'>
                            ...
                            <?php
                            $catalogo=1;
                            $sql = "SELECT  idProductosCategoria, productmain.codigo, productmain.descripcion, orden FROM productmain INNER JOIN productoscategoria ON productmain.codigo = productoscategoria.codigo  WHERE (productoscategoria.codCategoria = ? AND productoscategoria.codSubCategoria = ? AND productmain.catalogo = ?) ORDER BY productoscategoria.orden";
                            ...
                            $stmt->execute();
                            $stmt->store_result();
                            $stmt->bind_result($idProductosCategoria, $codigo, $descripcion, $orden);
                            $cont=1;
                            ...
                            while ($stmt->fetch()) { ?>
                                    ...
                                    <tr class="even pointer">
                                        ...
                                        <td class=" last">
                                            <form method="post" action="productos-update-orden.php?categorias=<?php echo $categorias;?>&idProductosCategoria=<?php echo $idProductosCategoria;?>">
