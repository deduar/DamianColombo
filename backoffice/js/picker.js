...
Calendar.prototype.show = function() {
	...
	this.wwrite("<A HREF=\"" +
		...
		");" +
		"\"><IMG SRC=izquierda.gif border=0><\/A></TD><TD ALIGN=center>");
	this.wwrite("<A HREF=\"" +
		"javascript:window.opener.Build(" + 
		"'" + this.gReturnItem + "', '" + prevMM + "', '" + prevYYYY + "', '" + this.gFormat + "'" +
		");" +
		"\"><IMG SRC=izq.gif border=0><\/A></TD><TD ALIGN=center>");
	this.wwrite("<A HREF=\"javascript:window.print();\"><IMG SRC=print.gif border=0></A></TD><TD ALIGN=center>");
	this.wwrite("<A HREF=\"" +
		"javascript:window.opener.Build(" + 
		"'" + this.gReturnItem + "', '" + nextMM + "', '" + nextYYYY + "', '" + this.gFormat + "'" +
		");" +
		"\"><IMG SRC=der.gif border=0><\/A></TD><TD ALIGN=center>");
	this.wwrite("<A HREF=\"" +
		"javascript:window.opener.Build(" + 
		"'" + this.gReturnItem + "', '" + this.gMonth + "', '" + (parseInt(this.gYear)+1) + "', '" + this.gFormat + "'" +
		");" +
		"\"><IMG SRC=derecha.gif border=0><\/A></TD></TR></TABLE><BR>");
