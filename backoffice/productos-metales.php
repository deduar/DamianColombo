...
$idMetalesRelacionado = isset($_GET['idMetalesRelacionado']) ? $_GET['idMetalesRelacionado'] : null;
...
<!--/////////////////////////////////////////////////////////////////////// -->
                            ...
                            <?php consultaProductoMetales($codigo); ?>

                            <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="post" action="productos-metales.php?codigo=<?php echo $codigo;?>">
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                                        <button type="submit" class="btn btn-success">Buscar Artículo</button>
                                    </div>
                                </div>
                            </form>
                                ...
                                while ($stmt->fetch()) { ?>
                                        ...
                                        <tr class="even pointer">
                                          <td class=' '><div class=''><img src='../assets\images\productos/<?php echo $codigoB;?>BIG1.jpg' class='imagen-lista'></div></td>
                                            ...
                                            <a href="productos-metales-insert.php?codigo=<?php echo $codigo;?>&codigoRelacionado=<?php echo $codigoB;?>&flagInicio=1">Relacionar</a>
