...
$result = mysql_query("SELECT * FROM pedidos where estado=0 ORDER BY fecha DESC");
$result1 = mysql_query("SELECT * FROM pedidos where estado=1 ORDER BY fecha DESC");
$result2 = mysql_query("SELECT * FROM pedidos where estado=2 ORDER BY fecha DESC");
$result3 = mysql_query("SELECT * FROM pedidos where estado=3 ORDER BY fecha DESC");
$result4 = mysql_query("SELECT * FROM pedidos where estado=4 ORDER BY fecha DESC");
$result5 = mysql_query("SELECT * FROM pedidos where estado=5 ORDER BY fecha DESC");
...
<!--/////////////////////////////////////////////////////////////////////// -->                                   
                                    ...
                                    <div class="" role="tabpanel" data-example-id="togglable-tabs">
                                        <ul id="myTab" class="nav nav-tabs bar_tabs" role="tablist">
                                            <li role="presentation" class="active"><a href="#tab_content1" id="home-tab" role="tab" data-toggle="tab" aria-expanded="true">PENDIENTE VALORIZACION</a>
                                            </li>
                                            <li role="presentation" class=""><a href="#tab_content2" role="tab" id="profile-tab" data-toggle="tab"  aria-expanded="false">PENDIENTE DE AUTORIZACION CLIENTE</a>
                                            </li>
                                                       ...
                                                       <table class="table table-striped responsive-utilities jambo_table bulk_action">
                                                            ...
                                                            ?>
                                                                    <tr class="even pointer">
                                                                        <td class=" "><b><? echo cambiaf_a_normal($fecha); ?></b></td>
                                                                        <td class=" "><? echo strtoupper($razon); ?></td>
                                                                        <td class=" "><? echo strtoupper($nombreFantasia); ?></td></td>
                                                                        <td class=" "><strong><? echo $id_pedido; ?></strong></td>
                                                                        <td class=" "><b><? echo $email; ?></b></td>
                                                                        <td class=" "><strong><? echo $estadoVer; ?></strong></div></td>
                                                                        <td class=" last">
