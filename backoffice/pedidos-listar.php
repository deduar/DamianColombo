...
$result = mysql_query("Select * from pedidos where id_pedido like '%$word%' order by id_pedido");

echo "Select * from pedidos where idPedido like '%$word%' order by id_pedido";
?>
                       ...
                       <table class="table table-striped responsive-utilities jambo_table bulk_action">
                                                            ...
                                                            ?>
                                                                    <tr class="even pointer">
                                                                        ...
                                                                        <td class=" "><? echo $razon; ?></td>
                                                                        <td class=" "><? echo $nombreFantasia; ?></td>
