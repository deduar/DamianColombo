<?php session_start();?>
<?ob_start();?>
<?php include ("incFunction2.php");?>
<?php include ("connect2.php");?>
<?php include ("seguridad.php");?>
<?php $word= isset($_POST['word']) ? $_POST['word'] : null; ?>
<!DOCTYPE html>
<html lang="en">
...
<!-- BEGIN CONTENIDO ////////////////////////////////////////////////////// -->                                
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="post" action="pedido-iniciar.php">
                                    ...
                                    <?resultadoConsultaProducto($word)?>
                                </div>
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                        ...
                                        <? while ($row = mysql_fetch_array($result)) { 
                                            ...
                                            <tr class="even pointer">
                                                ...
                                                <td class=" last">
                                                    ...
                                                    <a href="productoOutlet.php?idProductMain=<? echo $row["idProductMain"]; ?>">Editar</a>
