...
<!--/////////////////////////////////////////////////////////////////////// -->
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-3 col-sm-3 col-xs-12">
                                              ...
                                              <select class='form-control' name='certificado2'>
                                                ...
                                                <option value='1'>FANCY DIAMONDS</option>
                                                <option value='2'>SOLITARIOS</option>
                                                <option value='3'>CON PIEDRAS SECUNDARIAS</option>
                                              </select>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-2 col-sm-2 col-xs-12">
                                                <input type="text" name="diamond1" class="form-control" >
                                            </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-2 col-sm-2 col-xs-12">
                                                <input type="text" name="colorDistribution1" class="form-control" >
                                            </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-2 col-sm-2 col-xs-12">
                                                <input type="text" name="diamond2" class="form-control" >
                                            </div>
                                        ...
                                        <div class="form-group">
                                            <label class="control-label col-md-3 col-sm-3 col-xs-12">SHAPE</label>
                                            <div class="col-md-2 col-sm-2 col-xs-12">
                                                <input type="text" name="shape2" class="form-control" >
                                            </div>

                                            <label class="control-label col-md-1 col-sm-1 col-xs-12">CARAT </label>
                                            <div class="col-md-2 col-sm-2 col-xs-12">
                                                <input type="text" name="carat2" class="form-control" >
                                            </div>
                                            <label class="control-label col-md-1 col-sm-1 col-xs-12">COLOUR GRADE</label>
                                            <div class="col-md-2 col-sm-2 col-xs-12">
                                                <input type="text" name="colourGrade2" class="form-control" >
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="control-label col-md-3 col-sm-3 col-xs-12">CLARITY GRADE</label>
                                            <div class="col-md-2 col-sm-2 col-xs-12">
                                                <input type="text" name="clarityGrade2" class="form-control" >
                                            </div>

                                            <label class="control-label col-md-1 col-sm-1 col-xs-12">SYMMETRY </label>
                                            <div class="col-md-2 col-sm-2 col-xs-12">
                                                <input type="text" name="symmetry2" class="form-control" >
                                            </div>
                                            <label class="control-label col-md-1 col-sm-1 col-xs-12">COLOR ORIGIN </label>
                                            <div class="col-md-2 col-sm-2 col-xs-12">
                                                <input type="text" name="colorOrigin2" class="form-control" >
                                            </div>
                                        ...
                                        <div class="form-group">
                                            <label class="control-label col-md-3 col-sm-3 col-xs-12">COLOR DISTRIBUTION</label>
                                            <div class="col-md-2 col-sm-2 col-xs-12">
                                                <input type="text" name="colorDistribution2" class="form-control" >
                                            </div>
