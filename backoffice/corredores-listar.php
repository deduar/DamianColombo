...
<?
$result = mysql_query("Select * from usuarioMay where corredor=1 order by nombre");
?>
<!DOCTYPE html>
<html lang="en">
...
<!--/////////////////////////////////////////////////////////////////////// -->                                   
                                            <div role="tabpanel" class="tab-pane fade active in" id="tab_content1" aria-labelledby="home-tab">
                                                       <table class="table table-striped responsive-utilities jambo_table bulk_action">
                                                            <thead>
                                                                <tr class="headings">
                                                                    <th class="column-title">Corredor</th>
                                                            ...
                                                            ?>
                                                                    <tr class="even pointer">
                                                                        ...
                                                                        <td class=" last">
                                                                            <a href='usuario-editar.php?idUsuarioMay=<? echo $idUsuarioMay; ?>'>Editar</a> |  <a href='corredores-relacionados.php?idUsuarioMay=<? echo $idUsuarioMay; ?>'>Asignar Clientes</a> | <a href='usuario-editar.php?idUsuarioMay=<? echo $idUsuarioMay; ?>'>Ver Pedidos</a>
                                                                            </td>
                                                                    </tr>
