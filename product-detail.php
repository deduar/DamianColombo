      ...
      <div class="row">
        ...
        <div class="col-lg-5">
          <div class="product-single-content">
            ...
            <div class="row">
              <div class="col-lg-6 col-sm-6 col-6">
                ...
                <?php If ($codSubCategoria <> 6){ ?>
                  <?php calculoPrecio("detalle", $datosArticulo[2], $datosArticulo[29], $datosArticulo[30], 1); ?>
                  <!-- // VERIFICA EL STOCK-->
                <?php } ?>
              </div>
              <div class="col-lg-6 col-sm-6 col-6">
            ...
            If ($datosArticulo[32] >= 1 AND $codSubCategoria <> 6 ) {
               comboCantidad($datosArticulo[0], $datosArticulo[32], "gral", 0, $codigo, $datosArticulo[31]); ?>

            <?php }else{ 

              If ($datosArticulo[4] >= 1 AND $codSubCategoria <> 6 ) {

                comboCantidad($datosArticulo[0], $datosArticulo[4], "gral", 0, $codigo, $datosArticulo[31]); 
            ...
            <?php If ($datosArticulo[26]=='4'){ ?>
              <center><a data-toggle='modal' data-target='#exampleModalCenter' href='javascript:void(0);' class="linkMedida">Size Guide</a></center>
            ...
            <div class=" d-md-none"><hr>Description:<br><?php echo trim($datosArticulo[28]); ?></div>
            ...
            <div class="d-lg-none">
              <div class="row">
                <div class="col-lg-6 col-sm-6 col-6">
                    ...
                    <a href="whatsapp://send?text=http://en-us.damiancolombo.com/<?php echo $path; ?>" data-action="share/whatsapp/share">
        ...
        <div class="col-12">
          <div class="single-product-menu">
            <ul class="nav">
              ...
              <li><a data-toggle="tab" href="#review"> Contact Us </a></li>
            </ul>
          </div>
        </div>
        <div class="col-12">
                ...
                <div class="row">
                  ...
                  <div class="col-md-3 ratting-wrap">
                    ...
                    <table>
                      <thead>
                        <tr>
                          <th colspan="2">Secundary Stone</th>
                        </tr>
                      </thead>
                      <tbody>
                        <tr>
