                ...
                <div class="col-lg-6 offset-lg-3 col-md-8 offset-md-2 col-12">
                    ...
                    <?php if ($e=="2") : ?>
                          <div id="signalert2" class="alert alert-success">
                                <p>Your password was sent by email.</p>
                          </div>
                    <?php endif; ?>
                    <?php if ($flagReg=="1") : ?>
                          <div id="signalert2" class="alert alert-success">
                                <p>Your registration was validated correctly, enter with your data.</p>
                          </div>
                    <?php endif; ?>

                    <?php if ($e=="3") : ?>
                          <div id="signalert2" class="alert alert-success">
                                <p>To create your Wishlist you must login.</p>
                          </div>
                    <?php endif; ?>

                    <form action="recuperar-validacion.php" method="post" name="calform" id="calform">
                        ...
                        <div class="account-form form-style">
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <a href="recuperar-clave">Forgot your password?</a>
                                    <hr>
                                    <a href="registrarse">Register</a>
