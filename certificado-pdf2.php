...
$pdf->Image($imgProducto,105,55,0);

$pdf->SetFont('Helvetica','',7);
$y=$y+7;
$pdf->SetXY($x, $y);
$pdf->MultiCell(80, 5, utf8_encode($datosArticulo[25]));
//$pdf->insertarTxt(utf8_encode($datosArticulo[25]), $x, $y);
...
$pdf->line($x,$y,$x2,$y);
$y=$y+2;
$pdf->Image('assets/certificados/img/colour1.png',25,$y,0);
$pdf->Image('assets/certificados/img/colour2.png',58,$y,0);
$pdf->Image('assets/certificados/img/colour3.png',91,$y,0);
$pdf->Image('assets/certificados/img/colour4.png',124,$y,0);
$pdf->Image('assets/certificados/img/colour5.png',157,$y,0);
$y=$y+20;

$pdf->SetFont('Helvetica','',8);
$y=$y+5;
$pdf->insertarTxt("D-F", 33, $y);
$pdf->insertarTxt("G-J", 66, $y);
$pdf->insertarTxt("K-M", 99, $y);
$pdf->insertarTxt("N-R", 132, $y);
$pdf->insertarTxt("S-Z", 166, $y);
$y=$y+5;
$pdf->insertarTxt("Colorless", 30, $y);
$pdf->insertarTxt("Near Colorless", 60, $y);
$pdf->insertarTxt("Faint", 98, $y);
$pdf->insertarTxt("Very ligth", 129, $y);
$pdf->insertarTxt("Ligth", 165, $y);
...
$pdf->SetFont('Helvetica','',7);
$y=$y+20;
$pdf->insertarTxt("Roud", 27, $y);
$pdf->insertarTxt("Princess", 42, $y);
$pdf->insertarTxt("Esmerald", 57, $y);
