        ...
        <div class="container">
            <div class="row">   
                    ...
                    <div class="col-lg-3 col-12">
                        <!-- IMAGENES  -->
                        <?php 
                        mostrarContenidoOnLine($idNoticia, 6, "AMPLIAR"); ?>
                        <br>
                        <?php mostrarContenidoOnLine($idNoticia, 2, "AMPLIAR"); ?>
                        <!-- FIN VIDEO -->
                        <center><?php mostrarContenidoOnLine($idNoticia, 5, "AMPLIAR"); ?></center>
                        <center><?php mostrarContenidoOnLine($idNoticia, 4, "AMPLIAR"); ?></center>
                    </div>
