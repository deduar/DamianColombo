...
<div class="blog-details-area">
    ...
    <?php
            ...
            $estado=1;
              ...
              $sql = "SELECT idNoticia, titulo, bajada, descripcion FROM noticias WHERE estado=?";
    ...
    ?>         
            <div class="col-lg-3 col-12">
                <?php mostrarContenidoOnLine($idNoticia, 6, "BLOG"); ?>
            </div>
            ...
            <div class="col-lg-9 col-12">
                        ...
                        <ul class="product-tags">
                            <li><a href="blog-ampliar.php?idNoticia=<?php echo $idNoticia;?>">Ampliar</a></li>
                        </ul>
